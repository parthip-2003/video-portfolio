      ...
      {isLoading && (
        ...
        >
          ...
          <motion.div 
            ...
            className="relative text-3xl md:text-5xl font-black tracking-tighter"
          >
            {/* Background text (empty state) */}
            <div className="text-red-900/30">
              Parthip Sasidharan<span className="text-red-900/30">.</span>
            </div>
            ...
            >
              Parthip Sasidharan<span className="text-black">.</span>
            </motion.div>
          </motion.div>
